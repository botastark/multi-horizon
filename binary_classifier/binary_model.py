...
class LodgingClassifier(nn.Module):
    ...
    def __init__(
        ...
        super(LodgingClassifier, self).__init__()
        assert (
...
if __name__ == "__main__":
    input_tdim = 100
    ast_mdl = LodgingClassifier(input_tdim=input_tdim)
